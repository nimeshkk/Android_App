...
import 'package:campus_connect_app/pages/gpa_pages/grade_calculator.dart';
import 'edit_course_page.dart';

class GpaPageforeign extends StatefulWidget {
  @override
  _GpaPageState createState() => _GpaPageState();
}

class _GpaPageState extends State<GpaPageforeign> {
  List<Course> courses = [];
